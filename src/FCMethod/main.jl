...
bkg_scan = 0:0.001:25
mu_2_dic = load("/Users/fangchanghao/Documents/rareEventsAnalysis/analysisCode/src/likelihood_mu_bkg_data/mu2_0_20_0.9.jld")
b = getStepIndex(mu_2_dic["0"], 0.001)
println(mu_2_dic["0"][b])
plot(bkg_scan, mu_2_dic["0"])
scatter!(bkg_scan[b], mu_2_dic["0"][b])